...
public class BasePage {
    ...
    public void visibleElement(By element){
        List<WebElement> lk=driver.findElements(element);
        for(WebElement er:lk){
            if(er.isDisplayed()){
                er.click();
                return;
            }
        }
        throw new RuntimeException("No visible element found"+element);
    }
    ...
    public double calculatePercentage(double base, double percentage) {
        ...
        System.out.println("The percenrage is " + roundToTwoDecimals(value));
...
//    }
    ...
    public void hover(By element){
        ...
        ac.moveToElement(driver.findElement(element)).click().build().perform();
    }
